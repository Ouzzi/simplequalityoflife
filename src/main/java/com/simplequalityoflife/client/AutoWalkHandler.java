...
public class AutoWalkHandler {
    ...
    private static final KeyBinding.Category CATEGORY = KeyBinding.Category.create(Identifier.of(Simplequalityoflife.MOD_ID, "general"));
    ...
    public static void register() {
        ...
        autoWalkKey = KeyBindingHelper.registerKeyBinding(new KeyBinding(
                "key.simplequalityoflife.autowalk",
